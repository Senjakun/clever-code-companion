...
import { Monitor, Tablet, Smartphone, RefreshCw, ExternalLink, Code2, Eye, Expand, Shrink } from "lucide-react";
    ...
    <div className={cn(
      ...
      <div className="flex items-center justify-between px-4 py-3 border-b border-border/50 bg-card/50 backdrop-blur-sm">
        <div className="flex items-center gap-3">
          ...
          {/* URL Bar */}
          <div className="hidden sm:flex items-center gap-2 px-3 py-1.5 rounded-lg bg-secondary/50 border border-border/50 min-w-[200px]">
            <div className="h-3 w-3 rounded-full bg-primary/30" />
            <span className="text-xs text-muted-foreground truncate">localhost:3000</span>
          </div>
        </div>
